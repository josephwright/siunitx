...
an \texttt{S} column then getting the appearance right can be challenging. This
approach is illustrated in Table~\ref{tab:xmpl:headers}, along with the use of
\cs{rowcolor} to provide a background color.
\begin{LaTeXdemo}[code and float]
  \begin{table}
    ...
    \centering
    \begin{tabular}
      {S[text-weight-to-mathm table-format = 3.3]}
      \rowcolor[gray]{0.9}
      \bfseries 123.456 \\
       23.45  \\
      123.4   \\
