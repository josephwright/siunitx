...
For these cases, the \opt{table-column-width} option is available. The standard
setting, \opt{0pt}, indicates that no fixing takes place. If a value is set for
this option then the tabular material is typeset to the specified width
