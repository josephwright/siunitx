...
\end{syntax}
Runs of products of numbers may be inserted using the \cs{numproduct}
function. This
acts in the same way as \cs{num}, but inserts either a symbol or phrase
...
\begin{table}
  ...
  \begin{tabular}{@{}>{\ttfamily}ll>{\ttfamily}l@{}}
    ...
    \midrule
      ...
      product-symbol       & Literal & \cs{ensuremath}\{\cs{times}\} \\
      product-phrase       & Literal & \verb*= by =                  \\
