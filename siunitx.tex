...
\cs{qty} and \cs{unit} functions. This is not the standard behavior as there
...
\cs{qtyproduct} function. The behavior of this function is similar to
...
function. The behavior of this function is similar to \cs{numrange}, but
...
behavior applies, and takes the values \opt{all}, \opt{none}, \opt{decimal}
...
behavior. A classic example would be in an all-bold section heading. As the
