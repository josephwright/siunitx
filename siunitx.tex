...
\begin{table}
  ...
  \begin{tabular}{@{}>{\ttfamily}ll>{\ttfamily}l@{}}
    ...
    \midrule
      ...
      exponent-threshold-range & Literal & -3:3        \\
...
\end{LaTeXdemo}
\DescribeOption{exponent-threshold-range}
...
\opt{exponent-threshold-range}, which is given as
    ...
    \begin{tabular}
      {
        ...
        S[exponent-mode = threshold, exponent-threshold-range = -2:2]
        @{}
      }
    \toprule
