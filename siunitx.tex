...
Multiple uncertainties can be given for a number. These are always printed
in a separated form. When there is more than one uncertainty part, it may be
useful to describe the nature of this value. This can be achieved using the
\opt{uncertainty-descriptors} option, which take a comma-separated list of
descriptions.
\begin{LaTeXdemo}
  \num{1.2(3)(4)} \\
  \num[uncertainty-descriptors = {sys, stat}]{1.2(3)(4)}
\end{LaTeXdemo}
